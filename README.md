...
**Prerelease: 0.1.0-beta.1.** Target-device performance acceptance remains pending.
...
npm install /path/to/node-red-dashboard-2-bit-led-0.1.0-beta.1.tgz
```
...
```sh
npm install github:oleru/node-red-contrib-dashboard2-bit-led#v0.1.0-beta.1
```
